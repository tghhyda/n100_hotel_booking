...
class CheckedInView extends GetView<HistoryController>{
  CheckedInView({super.key});
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<BookingModel>>(
      future: controller.fetchCheckedInBookings(), // Hàm này cần được định nghĩa trong HistoryController
