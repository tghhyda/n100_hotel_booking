...
class PaymentCompletedView extends GetView<HistoryController>{
  PaymentCompletedView({super.key});
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<BookingModel>>(
      future: controller.fetchPaidBookings(), // Hàm này cần được định nghĩa trong HistoryController
